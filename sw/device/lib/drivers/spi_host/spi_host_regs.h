...
#define SPI_HOST_COMMAND_LEN_MASK 0xffffff
...
#define SPI_HOST_COMMAND_CSAAT_BIT 24
#define SPI_HOST_COMMAND_SPEED_MASK 0x3
#define SPI_HOST_COMMAND_SPEED_OFFSET 25
...
#define SPI_HOST_COMMAND_DIRECTION_OFFSET 27
